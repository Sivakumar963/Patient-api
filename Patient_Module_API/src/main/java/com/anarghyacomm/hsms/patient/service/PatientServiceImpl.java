...
public class PatientServiceImpl implements PatientService {
	...
	public PatientEntity addPatent(PatientEntity add) {
		...
		int randomPatientId = 10000 + random.nextInt(99999);  // Generates a random number between 100000 and 999999
	 ...
	 public Optional<PatientEntity> getPatientId(int patientId) {
